...
namespace Turkey
{
    public class Program
    {
        ...
        public static readonly Option<string> testNameOption = new Option<string>(
            new string[] { "--test-name", "-n" },
            "Runs a single test within the test root directory with the set name.");
